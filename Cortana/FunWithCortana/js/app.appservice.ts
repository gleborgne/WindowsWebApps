...
(function () {
    ...
    var requestProcessors = {
        "whenIsTripToDestination": function (connection: Windows.ApplicationModel.VoiceCommands.VoiceCommandServiceConnection, command: Windows.ApplicationModel.VoiceCommands.VoiceCommand) {
            App.Data.getTrips().then(function (trips) {
                try {
                    ...
                    var commandTiles: Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile[] = [];
    ...
    function requestReceived(connection: Windows.ApplicationModel.VoiceCommands.VoiceCommandServiceConnection, command: Windows.ApplicationModel.VoiceCommands.VoiceCommand) {
